...
- Elm &mdash; [Elm](https://elm-lang.org)
- elvish &mdash; [elvish](https://elv.sh/get/)
- factor &mdash; [factor](https://factorcode.org)
- Go &mdash; [Go](https://go.dev/dl/)
- Hy &mdash; [Hy](https://hylang.org)
...
- klongpy &mdash; [klongpy](https://github.com/briangu/klongpy)
...
- Perl &mdash; [git](https://git-scm.com)
- Picat &mdash; [Picat](https://picat-lang.org)
